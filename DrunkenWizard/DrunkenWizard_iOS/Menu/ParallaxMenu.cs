...
namespace JokesV2
{
    ...
    public class ParallaxMenu : UIViewController
    {
        ...
        public nfloat ContentViewInLandscapeOffsetCenterX { get; set; }

        public nfloat ContentViewInPortraitOffsetCenterX { get; set; }
        ...
        public ParallaxMenu(string nibName, NSBundle bundle) : base(nibName, bundle)
        {
            WantsFullScreenLayout = true;
            AnimationDuration = 0.65f;
        ...
        private void RedisplayController(UIViewController controller, CGRect frame)
        {
        ...
        private void ShowMenuViewController()
        {
            ...
            UIView.Animate(AnimationDuration, () =>
            {
                var tView = (_contentViewController as UINavigationController).TopViewController as ITopView;
                if (tView != null)
                    tView.ToggleMenu();

                if (ScaleContentView)
                {
                    //var v = (_contentViewController as UINavigationController);
                    //var navbar = v.NavigationBar;
                    //navbar.Alpha = 0;

                    var t = CATransform3D.Identity;
                    t = t.Translate(0, 100, 0);
                    _contentViewController.View.Layer.Transform = t;
                ...
                _contentViewController.View.Center = new CGPoint(x, y);
